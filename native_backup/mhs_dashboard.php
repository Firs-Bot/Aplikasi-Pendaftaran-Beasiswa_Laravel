...
if (isset($_POST['edit_full_mhs'])) {
    ...
    // Cek Status (Jika sudah Lolos/Ditolak tidak boleh edit - Optional Security)
    // Tapi requirement hanya bilang admin yang gabisa edit. Mahasiswa diasumsikan bisa kecuali dikunci sistem.
    // Kita biarkan mahasiswa edit data text, tapi validasi PDF tetap berlaku jika upload ulang.
    ...
    // Jika ada upload tapi bukan PDF
            ...
            <div class="tab-pane fade" id="status">
                ...
                <div class="list-group">
                    ...
                    while ($s = mysqli_fetch_assoc($q_stat)) {
                        ...
                        $warna = "list-group-item-secondary"; // Default (Menunggu)
                        if($st == 'SEDANG DITINJAU') $warna = "list-group-item-warning"; // Kuning
