...
// Gabungkan pengecekan: Role Admin menangani semua fungsi
if ($_SESSION['role'] != 'admin') header("Location: login.php");

//  LOGIC BEASISWA 
// Tambah Beasiswa (Plus Foto)
...
// LOGIC VERIFIKASI (Mantan Fitur BAAK)
if (isset($_POST['keputusan'])) {
    $id = $_POST['id_pendaftaran'];
    $keputusan_baru = $_POST['keputusan']; // Bisa: 'SEDANG DITINJAU', 'LOLOS', 'DITOLAK'

    // Cek Status Saat Ini (Locking Mechanism)
...
<body>
    ...
    <div class="container my-5">
        ...
        <!-- END BAGIAN KELOLA BEASISWA -->

        <?php } else if ($page == 'kelola') { ?>

        <!-- BAGIAN KELOLA PENDAFTARAN -->
