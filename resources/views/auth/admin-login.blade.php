<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-600">Masuk ke panel manajemen beasiswa</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login') }}">
        ...
        <!-- Username -->
        <div>
            <x-input-label for="nim_username" :value="__('Username Administrator')" />
        ...
        <div class="flex flex-col items-center justify-center mt-6 gap-4">
            ...
            <a class="underline text-sm text-gray-600 hover:text-indigo-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
                Bukan Admin? Login sebagai Mahasiswa
            </a>
        </div>
    </form>
</x-guest-layout>
